...
SELECTED_LOG_METRICS = {
    ...
    "noisy/effective_update_count",
    "noisy/effective_update_rate",
    "noisy/zero_update_count",
    "noisy/zero_update_rate",
    "clean/effective_update_count",
    "clean/effective_update_rate",
    "clean/zero_update_count",
    "clean/zero_update_rate",
